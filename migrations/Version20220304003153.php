 ...
 */
final class Version20220304003153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD prix_total INT NOT NULL, CHANGE prix user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD prix INT NOT NULL, DROP user_id, DROP prix_total');
